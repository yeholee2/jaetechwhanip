...
const fallbackSparrings: Sparring[] = [
  ...
  {
    id: 'demo-active-pension',
    round_number: 217,
    category: '절세',
    title: '국민연금 보험료율 9% → 13% 인상안, 찬성하시나요?',
    body: '노후 보장을 위한 인상이 필요하다는 입장과 현재 청년·중장년의 보험료 부담이 너무 크다는 입장이 갈려요. 여러분은 어느 쪽이세요?',
    ...
    side_b_polarity: 'negative',
    thumbnail_url: null,
    deadline_at: new Date(now + 5 * 24 * 60 * 60 * 1000 + 12 * 60 * 60 * 1000).toISOString(),
    status: 'active',
    created_at: new Date(now - 18 * 60 * 60 * 1000).toISOString(),
    stats: { votes_a: 412, votes_b: 638, votes_total: 1050, comment_count: 27 },
  },
  {
    id: 'demo-past-isa',
    round_number: 214,
