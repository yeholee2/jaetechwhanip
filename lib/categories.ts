...
export const CATEGORY_DEFINITIONS: CategoryDefinition[] = [
  ...
  },
  {
    ...
    emoji: '📈',
    title: '국내주식·ETF 질문',
    description: '국내주식, 국내 ETF, 배당, 장기투자처럼 투자자가 자주 묻는 질문을 모았어요.',
    keywords: ['국내주식', '국내 ETF', '배당', '장기투자'],
    aliases: ['stocks-etf', '주식-etf', '주식·ETF'],
  },
  {
    key: '해외주식·ETF',
    label: '해외주식·ETF',
    ...
    emoji: '🌎',
    title: '해외주식·ETF 질문',
    description: '미국주식, S&P500, 해외 ETF, 환율 고민처럼 해외 투자자가 자주 묻는 질문을 모았어요.',
    keywords: ['해외주식', '미국주식', 'S&P500', '해외 ETF'],
    aliases: ['global-stocks-etf', '미국주식', '해외주식'],
  },
  {
    key: '절세',
    label: '절세',
